...
apiErrors: { requestFailed: "Request failed", requestCanceled: "Request canceled", baseUrlRequired: "Configure the Base URL first", apiKeyRequired: "Configure the API key first", authenticationFailed: "Authentication failed. Check the API key, plan permissions, and model permissions.", rateLimited: "The request was rate-limited or the quota is insufficient. Try again later.", notFound: "The endpoint was not found (404). Check the Base URL and selected model.", badGateway: "Gateway error (502). The API service is temporarily unavailable.", serviceBusy: "Service unavailable (503). Try again later.", httpFailed: "Request failed (HTTP {{status}}). Check the Base URL and API key.", htmlError: "The service returned an HTML error page ({{preview}})", imageTimeout: "The image request timed out. The endpoint did not respond in time; retry later or switch channels.", audioModelRequired: "Configure an audio model first", audioGenerationFailed: "Audio generation failed", scriptNoAudio: "The model request script did not return audio", geminiAudioUnsupported: "The Gemini API format does not support audio generation. Use an OpenAI-format provider.", invalidImageSizeFormat: "Unsupported image size. Use auto, 9:16, or 1024x1024.", positiveImageRatio: "The image ratio must use positive numbers, such as 9:16.", imageRatioLimit: "The image aspect ratio cannot exceed 3:1. Adjust the dimensions.", positiveImageDimensions: "Image dimensions must be positive integers, such as 1024x1024.", imageDimensionStep: "Image width and height must be multiples of 16.", imageEdgeLimit: "The longest image edge cannot exceed 3840px.", imagePixelLimit: "The total image pixel count must be between 655360 and 8294400.", unknownImageResponse: "The API returned data in an unknown format (fields: {{fields}}). Check model or API compatibility.", noImageReturned: "The API did not return an image. The prompt may have triggered safety review or the model may not support this operation.", geminiRejected: "Gemini rejected the request: {{reason}}", geminiNoImage: "The Gemini API did not return an image", maskModelUnsupported: "This model does not support mask editing. Use another provider.", noContent: "No content returned", modelReadFailed: "Failed to load models", videoTimeout: "{{provider}}video generation timed out. Try again later.", pluginVideoExpired: "The plugin video task has expired. Generate it again.", scriptNoVideo: "The model request script did not return a video", noPlayableVideo: "The video API did not return a playable video", noVideoTaskId: "The video API did not return a task ID", videoTaskCreateFailed: "Failed to create video task", videoGenerationFailed: "Video generation failed", videoTaskQueryFailed: "Failed to query video task", videoPromptRequired: "Enter a video prompt or connect a reference image, video, or audio asset", referenceImageReadFailed: "Failed to read the reference image. Choose another image or upload it again.", invalidReferenceVideo: "A reference video must be a public URL, asset ID, or locally saved video", invalidReferenceAudio: "Reference audio must be a public URL, asset ID, or locally saved audio file", videoModelRequired: "Configure a video model first", geminiVideoUnsupported: "The Gemini API format does not support video generation. Use an OpenAI-format provider.", noVideoTask: "The API did not return a video task", videoDownloadFailed: "Failed to download video", localAssetReadFailed: "Failed to read local asset" , apimartMaskUnsupported: "APIMart does not support mask editing", apimartUploadFailed: "APIMart reference upload failed: {{detail}}", apimartUploadNoUrl: "APIMart reference upload returned no URL", apimartReferenceRequired: "This model requires a prompt or reference image/video", apimartTooManyReferences: "APIMart accepts at most 9 images", apimartTaskQueryFailed: "Failed to query APIMart task", apimartTaskFailed: "APIMart generation task failed", apimartTaskTimeout: "APIMart generation task timed out. Try again later.", apimartNoTaskId: "The APIMart API did not return a task ID" },
    ...
    navigation: {
        ...
        capabilities: { title: "Local capabilities (MCP tools)", description: "Invoke any MCP tool registered by the local Agent directly from the web page, including canvas operations, timeline media import, GitHub backup, APIMart video, and WebGPU depth extraction.", inputLabel: "Input JSON", run: "Run", invalidJson: "Input is not valid JSON" },
    workflows: {
    ...
    editor: {
        ...
        importAssets: "Import Media",
        importModalTitle: "Import Media to Timeline Studio",
        tabMyAssets: "My Assets",
        tabCanvasNodes: "Canvas Media",
        selectAssetsHint: "Check the media assets you want to send to the timeline editor",
        selectProject: "Select Canvas Project",
        selectedCount: "{{count}} items selected",
        confirmImport: "Import {{count}} selected items",
        noMediaAssets: "No image, video, or audio assets found in My Assets",
        noCanvasMedia: "No image, video, or audio nodes found in this canvas project",
        importEmpty: "Please select at least one media asset",
        importSuccess: "Successfully sent {{count}} items to Timeline Studio",
        importFailed: "Failed to import media assets. Please try again.",
        editorNotReady: "Timeline Studio is still initializing. Please wait a moment.",
    },
    topNav: {
    ...
    agent: {
        ...
        siteTools: { canvasList: "Canvas list", generationStatus: "Generation task status", imageConfig: "Image configuration", imageGenerate: "Generate in Image Studio", videoConfig: "Video configuration", videoGenerate: "Generate in Video Studio", promptSearch: "Search prompts", assetList: "Asset list", assetAdd: "Add asset", unknownTool: "Unknown tool: {{name}}", canvasLoading: "The canvas is still loading. Try again shortly.", canvasHint: "Use site_navigate to open /canvas/{id}", assetsLoading: "Assets are still loading. Try again shortly.", assetTitleRequired: "Provide the asset title", textContentRequired: "content is required when kind=text", imageUrlRequired: "imageUrl is required when kind=image", imageReadFailed: "Could not read the image. Use a data URL or a cross-origin accessible image URL.", assetKindUnsupported: "assets_add supports only kind=text or kind=image", imageGenerationStarted: "Opened Image Studio and started generation. Use generation_get_status to query the task.", imageConfigApplied: "Opened Image Studio and applied the parameters without starting generation.", videoGenerationStarted: "Opened Video Studio and started generation. Use generation_get_status to query the task.", videoConfigApplied: "Opened Video Studio and applied the parameters without starting generation.", workflowsApplyTemplate: "Apply workflow template", editorImportMedia: "Import media to editor", syncGithubBackup: "GitHub backup", apimartGenerateVideo: "APIMart video generation", apimartTaskStatus: "APIMart task status", depthModelStatus: "Depth model status", depthModelPrefetch: "Prefetch depth model", unknownWorkflowTemplate: "Unknown workflow template", editorNotOpen: "Open the AI editor page (/editor) first, then import media", editorNoMedia: "No importable media found in the selected sources", editorImportTimeout: "Media import timed out. Check whether the editor loaded correctly.", githubProviderRequired: "Switch to GitHub repository mode in Settings → Cloud Sync first", githubConfigRequired: "Fill in the GitHub repository and access token in Settings first", apimartChannelRequired: "No APIMart channel found. Create one in Settings first.", apimartStarted: "APIMart video task submitted. Results will appear in My Assets.", apimartTaskNotFound: "APIMart task not found" },
        connect: { pluginTitle: "Option 1: One-click install local Agent plugin (supports Codex / CodeG / any MCP)", pluginTextEnhanced: "Use the buttons below to trigger native protocol installation into Codex or CodeG, or copy the universal MCP start command. Compatible with Codex, CodeG, ZCode, Cursor, Claude Code, Cline, and any MCP-compliant Agent.", directTitle: "Option 2: Run Agent directly from repository source (supports timeline & video features)", directTextEnhanced: "Because this fork has deeply integrated Timeline Studio editing and APIMart video flows, the upstream npm package does not yet include these skills. Use the clone-and-run command below, or download the source archive to launch canvas-agent locally:", downloadAgentSource: "Download repository source archive (includes full canvas-agent):", ghDirect: "GitHub direct download", ghProxy: "GitHub accelerated mirror", repoLink: "Repository home", agentSourceLink: "canvas-agent source folder", oneClickCodex: "Install to Codex", oneClickCodeg: "Install to CodeG", oneClickZed: "Install to Zed / VSCode", oneClickMcp: "Copy universal MCP command", cloneRunTitle: "Clone and start latest Agent source in one line:", viewPluginDocs: "Plugin & skills docs", agentCompatibilityHint: "Compatibility: supports Codex, CodeG, ZCode, Cursor, Cline, Claude Code, Windsurf, and any client implementing the Model Context Protocol.", commandCopied: "Command copied", pluginReminder: "Install reminder", pluginReminderText: "Tools enter your Agent context (and consume tokens) only after the plugin or MCP is registered in the runtime. Running the agent process alone does not register MCP tools in the client.", copyCommand: "Copy command", title: "Connect local Agent", description: "Choose the connection method that fits your workflow.", webConnection: "Web connection", autoDiscover: "The Local URL and Connect token are discovered automatically by default. Enter them manually only if discovery fails.", disconnect: "Disconnect", connect: "Connect", localAddress: "Local address", urlPlaceholder: "For example http://127.0.0.1:17371", token: "Connection token", tokenPlaceholder: "Discover automatically or enter the Connect token" },
